...
**Som** ledare **vill jag** kunna se varför min inskickade övning fick åtgärda, ändra den och skicka in den igen, **så att** den kan bli godkänd.
...
- 15 (skicka in en övning till banken), 16 (redaktören granskar en inskickad övning).

## Utanför denna berättelse

- Chatt eller tvåvägskommunikation mellan ledare och redaktör utöver kommentaren vid `atgarda` (se backlog, Could).
