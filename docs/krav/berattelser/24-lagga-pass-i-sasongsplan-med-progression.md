...
5. **(Förslag, godkänns vid K1 – se kravspec.md, avsnittet "Beslut vid K1", förslag A.)** **Givet** att ledaren kopplar ett pass till en vecka vars ålder (R-113) skiljer sig från åldern passet skapades för, **när** kopplingen görs, **då** varnar appen om att passets ålder inte stämmer med veckans ålder. **Givet** att passet innehåller en övning märkt `nickspel` och veckans ålder är under 13 år, **då** varnar appen alltid, oavsett vilken ålder passet skapades för (R-080, R-113).
