...
14. **Givet** att ledaren är 13 år eller äldre och har valt `nickspel` som fokus, **när** passet genereras, **då** är den sammanlagda tiden för övningar som har `nickspel` bland sina fokusområden högst 10 minuter för åldersfasen 13–14 år och högst 20 minuter för åldersfasen 15–19 år, oavsett hur många sådana övningar som annars skulle matcha (R-082).
...
16. **Givet** att inga övningar alls matchar underlaget, **då** hanteras det enligt berättelse 03, inte genom att visa ett tomt eller felaktigt pass.
